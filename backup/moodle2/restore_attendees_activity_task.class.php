...
require_once($CFG->dirroot . '/mod/attendees/backup/moodle2/restore_attendees_stepslib.php'); // Because it exists (must)
...
class restore_attendees_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_attendees_activity_structure_step('attendees_structure', 'attendees.xml'));
    }
