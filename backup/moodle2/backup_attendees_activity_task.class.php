...
/**
 * Defines backup_attendees_activity_task class
 *
...
require_once($CFG->dirroot . '/mod/attendees/backup/moodle2/backup_attendees_stepslib.php');
...
class backup_attendees_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the attendees.xml file
     */
    protected function define_my_steps() {
        $this->add_step(new backup_attendees_activity_structure_step('attendees_structure', 'attendees.xml'));
    }
