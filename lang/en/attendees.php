...
$string['cannotdeletelastlocation'] = 'Cannot delete the last location. Please add another location before deleting this one.';
...
$string['invalidlocation'] = 'Invalid location. Please try again.';
...
$string['locationadded'] = 'Location created.';
$string['locationdatamissing'] = 'Location data missing or invalid. Please try again.';
...
$string['modulenameplural'] = 'Attendees';
$string['nosignout'] = 'Did not sign out';
$string['notsetup'] = 'Attendees module is not fully set up. Please contact your course administrator.';
$string['onlyin'] = 'Only signed in';
$string['onlyout'] = 'Only signed out';
$string['optionsheader'] = 'Display options';
$string['overwatch'] = 'Oversee Attendees';
...
$string['separatelocations'] = 'Separate Locations';
$string['separatelocationsexplain'] = 'Treat each location as a separate sign in/out location.';
...
$string['viewnotavailable'] = 'Requested view is not valid for this module.';
